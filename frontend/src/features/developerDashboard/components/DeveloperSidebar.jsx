// src/features/developerDashboard/components/DeveloperSidebar.tsx
    ...
    return (
        <aside className="developer-sidebar">
            <ul>
                ...
                <li>
                    <Link to="/developer-dashboard/calendar-entries">Calendar Entries</Link>
                </li>
                <li>
                ...
                <li>
                    <Link to="/developer-dashboard/quickbooks-tokens">QuickBooks Tokens</Link>
                </li>
                <li>
